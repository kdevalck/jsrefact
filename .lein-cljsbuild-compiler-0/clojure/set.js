...
return cljs.core.cons(max,cljs.core.remove((function (p1__3204_SHARP_){
return (max === p1__3204_SHARP_);
}),coll));
});
/**
...
var G__3206__delegate = function (s1,s2,sets){
...
var G__3206 = function (s1,s2,var_args){
var sets = null;
if (goog.isDef(var_args)) {
  sets = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return G__3206__delegate.call(this, s1, s2, sets);
};
G__3206.cljs$lang$maxFixedArity = 2;
G__3206.cljs$lang$applyTo = (function (arglist__3207){
var s1 = cljs.core.first(arglist__3207);
var s2 = cljs.core.first(cljs.core.next(arglist__3207));
var sets = cljs.core.rest(cljs.core.next(arglist__3207));
return G__3206__delegate(s1, s2, sets);
});
...
var G__3210__delegate = function (s1,s2,sets){
var bubbled_sets = clojure.set.bubble_max_key((function (p1__3205_SHARP_){
return (- cljs.core.count(p1__3205_SHARP_));
...
var G__3210 = function (s1,s2,var_args){
var sets = null;
if (goog.isDef(var_args)) {
  sets = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return G__3210__delegate.call(this, s1, s2, sets);
};
G__3210.cljs$lang$maxFixedArity = 2;
G__3210.cljs$lang$applyTo = (function (arglist__3211){
var s1 = cljs.core.first(arglist__3211);
var s2 = cljs.core.first(cljs.core.next(arglist__3211));
var sets = cljs.core.rest(cljs.core.next(arglist__3211));
return G__3210__delegate(s1, s2, sets);
});
...
var G__3212__delegate = function (s1,s2,sets){
return cljs.core.reduce.cljs$lang$arity$3(difference,s1,cljs.core.conj.cljs$lang$arity$2(sets,s2));
};
var G__3212 = function (s1,s2,var_args){
var sets = null;
if (goog.isDef(var_args)) {
  sets = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return G__3212__delegate.call(this, s1, s2, sets);
};
G__3212.cljs$lang$maxFixedArity = 2;
G__3212.cljs$lang$applyTo = (function (arglist__3213){
var s1 = cljs.core.first(arglist__3213);
var s2 = cljs.core.first(cljs.core.next(arglist__3213));
var sets = cljs.core.rest(cljs.core.next(arglist__3213));
return G__3212__delegate(s1, s2, sets);
});
...
return cljs.core.set(cljs.core.map.cljs$lang$arity$2((function (p1__3214_SHARP_){
return cljs.core.select_keys(p1__3214_SHARP_,ks);
}),xrel));
});
/**
...
return cljs.core.reduce.cljs$lang$arity$3((function (m,p__3218){
var vec__3219 = p__3218;
var old = cljs.core.nth.cljs$lang$arity$3(vec__3219,0,null);
var new$ = cljs.core.nth.cljs$lang$arity$3(vec__3219,1,null);
...
return cljs.core.set(cljs.core.map.cljs$lang$arity$2((function (p1__3215_SHARP_){
return clojure.set.rename_keys(p1__3215_SHARP_,kmap);
}),xrel));
});
/**
...
return cljs.core.reduce.cljs$lang$arity$3((function (m__$1,p__3226){
var vec__3227 = p__3226;
var k = cljs.core.nth.cljs$lang$arity$3(vec__3227,0,null);
var v = cljs.core.nth.cljs$lang$arity$3(vec__3227,1,null);
...
var vec__3231 = (((cljs.core.count(xrel) <= cljs.core.count(yrel)))?cljs.core.PersistentVector.fromArray([xrel,yrel], true):cljs.core.PersistentVector.fromArray([yrel,xrel], true));
var r = cljs.core.nth.cljs$lang$arity$3(vec__3231,0,null);
var s = cljs.core.nth.cljs$lang$arity$3(vec__3231,1,null);
...
{return cljs.core.reduce.cljs$lang$arity$3((function (p1__3220_SHARP_,p2__3221_SHARP_){
return cljs.core.conj.cljs$lang$arity$2(p1__3220_SHARP_,cljs.core.merge.cljs$lang$arity$variadic(cljs.core.array_seq([p2__3221_SHARP_,x], 0)));
}),ret,found);
} else
{return ret;
}
...
var vec__3232 = (((cljs.core.count(xrel) <= cljs.core.count(yrel)))?cljs.core.PersistentVector.fromArray([xrel,yrel,clojure.set.map_invert(km)], true):cljs.core.PersistentVector.fromArray([yrel,xrel,km], true));
var r = cljs.core.nth.cljs$lang$arity$3(vec__3232,0,null);
var s = cljs.core.nth.cljs$lang$arity$3(vec__3232,1,null);
var k = cljs.core.nth.cljs$lang$arity$3(vec__3232,2,null);
...
if(cljs.core.truth_(found))
{return cljs.core.reduce.cljs$lang$arity$3((function (p1__3222_SHARP_,p2__3223_SHARP_){
return cljs.core.conj.cljs$lang$arity$2(p1__3222_SHARP_,cljs.core.merge.cljs$lang$arity$variadic(cljs.core.array_seq([p2__3223_SHARP_,x], 0)));
}),ret,found);
} else
{return ret;
}
...
if(and__3822__auto__)
{return cljs.core.every_QMARK_((function (p1__3228_SHARP_){
return cljs.core.contains_QMARK_(set2,p1__3228_SHARP_);
}),set1);
} else
{return and__3822__auto__;
}
...
var and__3822__auto__ = (cljs.core.count(set1) >= cljs.core.count(set2));
if(and__3822__auto__)
{return cljs.core.every_QMARK_((function (p1__3233_SHARP_){
return cljs.core.contains_QMARK_(set1,p1__3233_SHARP_);
}),set2);
} else
{return and__3822__auto__;
}
